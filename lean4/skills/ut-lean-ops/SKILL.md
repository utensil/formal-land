...
Out of scope: coordinating parallel work, managing branches or worktrees, monitoring, scheduling, chat relay, and the verification of executable programs. The last one is an extension (SOFTWARE_VERIFICATION.md), not part of the core; most formalization work never reaches it.
