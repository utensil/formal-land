...
| `ut-lean-review` | review protocol grounded on Tau Ceti coordination (default unless the project specifies its own review-process rules); Lean and math quality detection techniques; the latest Tau Ceti rubrics are the default quality gate for all math formalization reviews | rubrics from TauCetiProject/TauCetiReview; design rules from ut-lean-design |
