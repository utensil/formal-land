...
| `ut-lean-ops` | toolchain-level setup, cache, audits, fresh-checkout reproduction; the executable verification chain (EXECUTABLE.md) is a scoped extension gated on the project carrying executable content | check for independent-kernel verification |
